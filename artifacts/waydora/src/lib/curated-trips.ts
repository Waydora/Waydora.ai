// curated-trips.ts
// ⚠️ COPIA SINCRONIZZATA di artifacts/api-server/src/seed/curated-trips.ts
//    (la webapp non può importare dal package api-server). Se modifichi i viaggi
//    curati, aggiorna ENTRAMBI i file. Usata da inspire-page per caricare un
//    itinerario pronto senza chiamare l'AI (risparmio token).
// ─────────────────────────────────────────────────────────────────────────────
