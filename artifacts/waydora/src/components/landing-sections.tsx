...
const FAQ = [
  { q: "Waydora è gratuito?",                        a: "Sì. Gratis puoi creare fino a 3 itinerari al mese, con mappa, lista bagaglio e link di prenotazione, generare la lista bagaglio, usare il bot Telegram e condividere i viaggi con i compagni — chat di gruppo inclusa. Per meteo, calendario, gestione spese e modifiche con l'AI c'è Waydora Pro, con itinerari illimitati. Quando prenoti hotel o esperienze tramite i nostri link partner riceviamo una piccola commissione, senza nessun sovrapprezzo per te." },
  { q: "Cosa include Waydora Pro?",                  a: "Pro sblocca itinerari illimitati ogni mese, le modifiche con l'AI ai tuoi viaggi (anche quelli condivisi), meteo e calendario del viaggio, la gestione delle spese con scansione scontrini AI, una personalizzazione avanzata sui tuoi gusti ed esportazione senza limiti." },
  ...
  { q: "Posso modificare l'itinerario dopo averlo creato?", a: "Sì. Mentre lo crei lo affini liberamente in chat. Le modifiche con l'AI su un viaggio già salvato o condiviso — aggiungere giorni, cambiare destinazioni, ridurre il budget, inserire musei o ristoranti — sono incluse in Waydora Pro e si aggiornano in tempo reale per tutti i compagni." },
  ...
  { q: "Posso condividere un itinerario con un amico?", a: "Sì, ed è gratis: ogni viaggio salvato ha un link pubblico univoco da condividere via WhatsApp, email o copiando l'URL. Chi apre vede l'itinerario completo con mappa e lista bagaglio, e può scrivere nella chat dei compagni. Se il proprietario del viaggio è Pro, sul viaggio condiviso si sbloccano per tutto il gruppo anche meteo, calendario, spese e le modifiche con l'AI." },
