// Profilo viaggiatore (auto dai viaggi). Versione bot — speculare a quella della
// webapp (artifacts/waydora/src/lib/travel-profile.ts). Costruisce un riassunto
// compatto dei gusti dell'utente dai suoi itinerari salvati, da iniettare nel prompt.
