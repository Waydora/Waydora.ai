...
-- ============================================================================
-- Scopo: aggiunge colonna is_template a saved_trips e semina 6 itinerari
--        template (sola lettura, user_id NULL, is_public TRUE).
-- Eseguire dal Supabase SQL editor (gira come postgres → bypassa RLS).
--
-- NOTA: i blob JSON usano il DOLLAR-QUOTING di PostgreSQL ($json$...$json$)
--       così gli apostrofi italiani (dell', un', l') non vanno escapati.
-- ============================================================================


-- ── 1) Colonna is_template ───────────────────────────────────────────────────
alter table public.saved_trips
  add column if not exists is_template boolean not null default false;

create index if not exists idx_saved_trips_is_template
  on public.saved_trips (is_template)
  where is_template = true;


-- ── 2) RLS: proteggi i template da UPDATE/DELETE lato client ────────────────
--      Blocca qualsiasi DML su righe is_template=true per i ruoli non-service.
--      La SELECT resta aperta (policy is_public=true della 003). La semina
--      avviene come postgres/service-role che bypassa RLS.
drop policy if exists "saved_trips_no_modify_template" on public.saved_trips;
create policy "saved_trips_no_modify_template"
...
-- ── 3) Semina dei 6 template ────────────────────────────────────────────────
insert into public.saved_trips
  (share_slug, user_id, is_public, is_template, title, itinerary, notes, trip_id, created_at)
values

-- 1) Santorini
(
  'santorini', null, true, true,
  'Santorini in 3 giorni: tramonti, caldera e mare',
  $json${
    ...
    "heroEmoji": "🌅",
    "days": [
      {"day":1,"title":"Fira e la caldera","summary":"Arrivo, primo affaccio sulla caldera e tramonto sul vulcano.","activities":[
        ...
        {"time":"19:30","title":"Tramonto sulla caldera","description":"Aperitivo in un wine bar affacciato sul vulcano, lontano dalla calca di Oia.","category":"nightlife","estimatedCost":"€12–20","coordinates":{"lat":36.4170,"lng":25.4310},"photoQuery":"Santorini sunset wine bar caldera"}
      ]},
      {"day":2,"title":"Oia e il nord dell'isola","summary":"Il villaggio più iconico, un bagno alle terme e il tramonto famoso nel mondo.","activities":[
      ...
      {"day":3,"title":"Spiagge vulcaniche e vino","summary":"Il lato meno noto: sabbia nera e rossa, un sito archeologico e cantine.","activities":[
...
-- 2) Kyoto
(
  'kyoto', null, true, true,
  'Kyoto in 3 giorni: templi, bambù e geishe',
  $json${
    ...
    "heroEmoji": "⛩️",
    "days": [
      {"day":1,"title":"Higashiyama e Gion","summary":"Il cuore antico: templi, vicoli di pietra e il quartiere delle geishe.","activities":[
      ...
      {"day":2,"title":"Arashiyama e il nord-ovest","summary":"La foresta di bambù all'alba, un tempio zen e le scimmie di montagna.","activities":[
      ...
      {"day":3,"title":"Fushimi Inari e il sake","summary":"Le mille torii rosse all'alba e il quartiere delle distillerie.","activities":[
        {"time":"07:30","title":"Fushimi Inari all'alba","description":"Migliaia di torii vermiglie su per la montagna. All'alba è magico e deserto.","category":"sightseeing","estimatedCost":"Gratis","coordinates":{"lat":34.9671,"lng":135.7727},"photoQuery":"Fushimi Inari torii gates sunrise"},
    ...
    "packingList": [
      ...
      {"category":"Essenziali","items":["IC card (Suica/ICOCA) per i mezzi","Pocket wifi o eSIM","Contanti (molti posti no carta)"]},
...
(
  'costiera-amalfitana', null, true, true,
  'Costiera Amalfitana in 3 giorni: Positano, Amalfi e Ravello',
  $json${
    ...
    "heroEmoji": "🍋",
    "days": [
      {"day":1,"title":"Positano","summary":"Il borgo verticale a picco sul mare, tra boutique e spiaggia.","activities":[
      ...
      {"day":2,"title":"Sentiero degli Dei e Amalfi","summary":"Il trekking panoramico più bello d'Italia e la cittadina che dà il nome alla costa.","activities":[
      ...
      {"day":3,"title":"Ravello","summary":"Il balcone della costiera, tra ville, giardini e musica.","activities":[
...
(
  'bali', null, true, true,
  'Bali in 3 giorni: risaie, templi e spiagge',
  $json${
    ...
    "heroEmoji": "🌴",
    "days": [
      {"day":1,"title":"Ubud e le risaie","summary":"Il cuore verde e spirituale dell'isola.","activities":[
      ...
      {"day":2,"title":"Templi e cascate","summary":"Il Bali da cartolina: porte celesti, sorgenti sacre e giungla.","activities":[
      ...
      {"day":3,"title":"Sud: spiagge e scogliere","summary":"Surf, tempio sul mare e tramonto sull'oceano.","activities":[
...
-- 5) Dolomiti
(
  'dolomiti', null, true, true,
  'Dolomiti in 3 giorni: laghi, rifugi e vette',
  $json${
    ...
    "heroEmoji": "🏔️",
    "days": [
      {"day":1,"title":"Lago di Braies","summary":"Il lago alpino più fotografato delle Alpi.","activities":[
        {"time":"07:30","title":"Lago di Braies all'alba","description":"Lo smeraldo incorniciato dalle pareti: presto è specchio perfetto e parcheggio libero.","category":"sightseeing","estimatedCost":"Parcheggio €6–28","coordinates":{"lat":46.6947,"lng":12.0856},"photoQuery":"Lago di Braies sunrise Dolomites"},
        {"time":"09:00","title":"Giro del lago + barca a remi","description":"Anello pianeggiante di 3,5 km e le tipiche barche di legno sull'acqua verde.","category":"experience","estimatedCost":"Barca €32/30min","coordinates":{"lat":46.6950,"lng":12.0870},"photoQuery":"Braies wooden boats lake"},
      ...
      {"day":2,"title":"Tre Cime di Lavaredo","summary":"Il trekking simbolo delle Dolomiti, attorno alle tre torri.","activities":[
      ...
      {"day":3,"title":"Val di Funes e Seceda","summary":"Le creste affilate e la chiesetta più fotografata delle Alpi.","activities":[
...
-- 6) Polignano a Mare
(
  'polignano-a-mare', null, true, true,
  'Polignano a Mare e dintorni in 3 giorni',
  $json${
    ...
    "heroEmoji": "🏖️",
    "days": [
      {"day":1,"title":"Polignano a Mare","summary":"Il borgo a strapiombo sul mare e la sua spiaggia in grotta.","activities":[
      ...
      {"day":2,"title":"Monopoli e Alberobello","summary":"Un porto antico e il paese dei trulli, patrimonio UNESCO.","activities":[
      ...
      {"day":3,"title":"Grotte di Castellana e mare","summary":"Il mondo sotterraneo della Puglia e un ultimo bagno.","activities":[
...
-- ============================================================================
-- VERIFICA POST-SEMINA:
--   select share_slug, title, is_template, is_public, user_id
--   from public.saved_trips where is_template = true;
-- → devi vedere 6 righe (santorini, kyoto, costiera-amalfitana, bali,
--   dolomiti, polignano-a-mare).
--
-- PROMEMORIA (già applicato lato codice): is_template?: boolean in
--   artifacts/waydora/src/hooks/trips.ts. Bug separato: useSaveItinerary
--   (api.ts) scrive su Railway, non su saved_trips → task a parte.
-- ============================================================================
